...
const pricingCardVariants = cva("rounded-lg p-4 py-6 w-full", {
    variants: {
        variant: {
            ...
            highlighted: "bg-linear-to-br from-[#D82EFB] to-[#3F1E5C] text-white",
        },
    },
    defaultVariants: {
        variant: "default",
...
const pricingCardBadgeVariants = cva("text-black text-cs font-normal p-1", {
    variants: {
        variant: {
        ...
        <div className={cn(pricingCardVariants({ variant }), "border", className)}>
            <div className="flex items-end gap-x-4 justify-between">
                <div className="flex flex-col gap-y-2">
                    ...
                    <p 
                        className={cn("text-xs", pricingCardSecondaryTextVariants({ variant }))}
                    >
                        {description}
                    </p>
                </div>
